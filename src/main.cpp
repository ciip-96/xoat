...
#if defined(NDEBUG)
# error "Xoat cannot be compiled without assertions."
#endif
...
//int nStakeMinConfirmations = 5;
unsigned int nStakeMinAge = 6 * 60 * 60; // 6 hours
//unsigned int nStakeMinAge = 100 * 60; //10 minute
...
const string strMessageMagic = "Xoat Signed Message:\n";
