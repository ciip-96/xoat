...
namespace GUIUtil {
    ...
    void SetBlackThemeQSS(QApplication& app)
    {
        app.setStyleSheet("QWidget        { background: rgb(233,233,233); }"
                          ...
                          "QPushButton    { background: rgb(120,189,121); color: rgb(21,21,21); }"
                          ...
                          "QMenuBar       { background: rgb(233,233,233); color: rgb(110,116,126); }"
                          ...
                          "QTabBar::tab:selected  { background: rgb(233,233,233); }"
                          "QTabBar::tab:!selected { background: rgb(24,26,30); margin-top: 2px; }"
                          "QTabWidget::pane { border: 1px solid rgb(78,79,83); }"
                          "QToolButton    { background: rgb(128,64,128); color: rgb(116,122,134); border: none; border-left-color: rgb(30,32,36); border-left-style: solid; border-left-width: 6px; margin-top: 8px; margin-bottom: 8px; }"
                          ...
                          "QTreeView::item { background: rgb(233,233,233); color: rgb(212,213,213); }"
